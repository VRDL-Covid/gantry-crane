...
public class height_constraint : MonoBehaviour
{
    ...
    public Vector3 PositionUpdate(Vector3 velocityConn, int i,int k, GameObject anchor)
    {
        ...
        //vector = oldpos + gravity + (oldvel *0.8f) * Time.fixedDeltaTime;
        //vector = oldpos + gravity + (velocityConn*0.73f + oldvel*0.27f)*Time.fixedDeltaTime;
        ...
        angledeg = ((yrot * 180f / Mathf.PI)-transform.localRotation.y)*.5f + transform.localRotation.y;
